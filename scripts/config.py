...
CATEGORY_CATALOG: list[dict[str, Any]] = [
    ...
    # ── Added: broader coverage so a search "never misses" a category ──
    {"id": "financial_services", "label": "Financial & Insurance", "icon": "💰",
     "tags": [{"key": "office", "value": "financial"}, {"key": "office", "value": "insurance"},
               {"key": "amenity", "value": "bank"}, {"key": "office", "value": "tax_advisor"}]},
    {"id": "pet_services", "label": "Pet Services", "icon": "🐾",
     "tags": [{"key": "shop", "value": "pet"}, {"key": "amenity", "value": "animal_boarding"},
               {"key": "shop", "value": "pet_grooming"}]},
    {"id": "home_services", "label": "Home & Cleaning Services", "icon": "🧹",
     "tags": [{"key": "shop", "value": "laundry"}, {"key": "shop", "value": "dry_cleaning"},
               {"key": "office", "value": "cleaning"}, {"key": "shop", "value": "storage_rental"}]},
    {"id": "events_photography", "label": "Events & Photography", "icon": "📸",
     "tags": [{"key": "shop", "value": "photo"}, {"key": "amenity", "value": "events_venue"},
               {"key": "shop", "value": "florist"}]},
    {"id": "education_childcare", "label": "Education & Childcare", "icon": "🎓",
     "tags": [{"key": "amenity", "value": "childcare"}, {"key": "office", "value": "educational_institution"},
               {"key": "amenity", "value": "driving_school"}]},
    {"id": "travel_transport", "label": "Travel & Transport", "icon": "✈️",
     "tags": [{"key": "office", "value": "travel_agent"}, {"key": "shop", "value": "car_rental"},
               {"key": "amenity", "value": "taxi"}]},
    {"id": "specialty_trades", "label": "Specialty Trades", "icon": "🔧",
     "tags": [{"key": "shop", "value": "locksmith"}, {"key": "craft", "value": "locksmith"},
               {"key": "shop", "value": "car_wash"}, {"key": "shop", "value": "tattoo"}]},
    {"id": "funeral_services", "label": "Funeral Services", "icon": "🕊️",
     "tags": [{"key": "shop", "value": "funeral_directors"}]},
    {"id": "printing_signage", "label": "Printing & Signage", "icon": "🖨️",
     "tags": [{"key": "shop", "value": "copyshop"}, {"key": "craft", "value": "signmaker"}]},
    {"id": "entertainment", "label": "Entertainment & Recreation", "icon": "🎳",
     "tags": [{"key": "leisure", "value": "bowling_alley"}, {"key": "leisure", "value": "amusement_arcade"},
